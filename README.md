...
Backend developer experienced in designing and implementing server-side systems, APIs, and data storage solutions. Focus areas include API design (REST), scalable architecture, data modeling, performance optimization, and automated testing. Experienced in deploying services using containerization and CI/CD pipelines.
